...
public class TestHashMap {
  ...
  public static void main(String[] args) {
    HashMap<Fruit, String> fruits = new HashMap<Fruit, String>(2 ^ 4);
    ...
    // System.out.println("TestHashMap.main()" + fruits.put(new Fruit("Banana",
    // "Banana description", 90), "E"));
