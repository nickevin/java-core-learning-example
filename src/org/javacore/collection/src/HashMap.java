 ...
 * 
 * Copyright 2006 Sun Microsystems, Inc. All rights reserved. SUN PROPRIETARY/CONFIDENTIAL. Use is
...
public class HashMap<K, V> extends org.javacore.collection.src.AbstractMap<K, V> implements
  ...
  public V put(K key, V value) {
    ...
    // System.out.println("HashMap.put() hashcode: " + key.hashCode() + ", hash: " + hash +
    // ", idx: "
    // + idx + ", v:" + value);
