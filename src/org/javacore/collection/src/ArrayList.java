 ...
 * all elements, including <tt>null</tt>. In addition to implementing the <tt>List</tt> interface, this class provides
 ...
 * 
 * <p>
 * The iterators returned by this class's <tt>iterator</tt> and <tt>listIterator</tt> methods are <i>fail-fast</i>: if
 * the list is structurally modified at any time after the iterator is created, in any way except through the iterator's
 * own <tt>remove</tt> or <tt>add</tt> methods, the iterator will throw a {@link ConcurrentModificationException}. Thus,
...
public class ArrayList<E> extends AbstractList<E> implements List<E>, RandomAccess, Cloneable, java.io.Serializable {
	...
	/**
	 * Trims the capacity of this <tt>ArrayList</tt> instance to be the list's current size. An application can use this
